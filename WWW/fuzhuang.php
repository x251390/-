       ...
       导航
          ...
          <?php include('public/left.php');?>
			...
			<div class="yi center-block">
				...
				<span  class="yi center-block "><a href="" class="active">服装</a></span>
		...
		<img src="img/专家建议-服装_03.jpg" class="bei img-responsive"/>
	<div class="content2">
		<span>服装指南</span>
		看一看<br />
让你有意想不到的收获<br />
		...
		<div class="row">
			...
			<div class="col-md-1">
				...
				<div class="col-md-8 clearfix">
					...
					<div class="fu">服装技能文章<span class="jie">(29条结果)</span></div>
					<div class="clearfix">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="#">Separated link</a></li>
					...
					<ul class="list-inline list-unstyled tu">
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-服装_07.jpg" alt="" />
							<div>技能</div>
							<div class="dong">动物福利和户外装备</div>
							<div><img  src="img/si.jpg" alt="" /></div>
						</div>	
						</li>
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-服装_09.jpg" alt="" />
							<div>技能</div>
							<div class="dong">寒冷天气徒步旅行小贴士</div>
							<div><img  src="img/si.jpg" alt=""/> </div>
						</div>	
						</li>
					<li>
						<div class="xian1">
							<img class="xing" src="img/专家建议-服装_11.jpg" alt="" />
							<div>技能</div>
							<div class="dong">织物护理符号</div>
					...
					<ul class="list-inline list-unstyled tu">
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-服装_16.jpg" alt="" />
							<div>技能</div>
							<div class="dong">公平贸易食品和服务基础</div>
							<div><img  src="img/si.jpg" alt="" /></div>
						</div>	
						</li>
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-服装_17.jpg" alt="" />
							<div>技能</div>
							<div class="dong">防水雨具如何工作</div>
							<div><img  src="img/si.jpg" alt=""/> </div>
						</div>	
						</li>
					<li>
						<div class="xian1">
							<img class="xing" src="img/专家建议-服装_18.jpg" alt="" />
							<div>技能</div>
							<div class="dong">如何打破你的登山靴</div>
							<div><img  src="img/wu.jpg" alt="" /></div>
						</div>	
						</li>
					</ul>
					...
					<ul class="list-inline list-unstyled tu">
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-服装_22.jpg" alt="" />
							<div>技能</div>
							<div class="dong">如何选择和使用胫甲</div>
							<div><img  src="img/si.jpg" alt="" /></div>
						</div>	
						</li>
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-服装_23.jpg" alt="" />
							<div>技能</div>
							<div class="dong">如何选择基本面料</div>
							<div><img  src="img/si.jpg" alt=""/> </div>
						</div>	
						</li>
					<li>
						<div class="xian1">
							<img class="xing" src="img/专家建议-服装_25.jpg" alt="" />
							<div>技能</div>
							<div class="dong">如何选择自行车鞋</div>
							<div><img  src="img/wu.jpg" alt="" /></div>
						</div>	
						</li>
					</ul>
					...
					<ul class="list-inline list-unstyled tu">
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-服装_29.jpg" alt="" />
							<div>技能</div>
							<div class="dong">如何选择徒步旅行鞋</div>
							<div><img  src="img/si.jpg" alt="" /></div>
						</div>	
						</li>
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-服装_30.jpg" alt="" />
							<div>技能</div>
							<div class="dong">如何选择步袜</div>
							<div><img  src="img/si.jpg" alt=""/> </div>
						</div>	
						</li>
					<li>
						<div class="xian1">
							<img class="xing" src="img/专家建议-服装_32.jpg" alt="" />
							<div>技能</div>
							<div class="dong">如何选择绝缘外套</div>
							<div><img  src="img/wu.jpg" alt="" /></div>
						</div>	
						</li>
					</ul>
					...
					<ul class="list-inline list-unstyled tu">
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-服装_38.jpg" alt="" />
							<div>技能</div>
							<div class="dong">如何选择雨衣</div>
							<div><img  src="img/si.jpg" alt="" /></div>
						</div>	
						</li>
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-服装_40.jpg" alt="" />
							<div>技能</div>
							<div class="dong">如何选择攀岩鞋</div>
							<div><img  src="img/si.jpg" alt=""/> </div>
						</div>	
						</li>
					<li>
						<div class="xian1">
							<img class="xing" src="img/专家建议-服装_42.jpg" alt="" />
							<div>技能</div>
							<div class="dong">如何选泽可持续服装和装备</div>
							<div><img  src="img/wu.jpg" alt="" /></div>
						</div>	
						</li>
					</ul>
				    ...
				    <ul class="list-inline list-unstyled tu">
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-服装_47.jpg" alt="" />
							<div>技能</div>
							<div class="dong">如何选泽清洁远足鞋</div>
							<div><img  src="img/si.jpg" alt="" /></div>
						</div>	
						</li>
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-服装_48.jpg" alt="" />
							<div>技能</div>
							<div class="dong">如何清洁跑鞋</div>
							<div><img  src="img/si.jpg" alt=""/> </div>
						</div>	
						</li>
					<li>
						<div class="xian1">
							<img class="xing" src="img/专家建议-服装_49.jpg" alt="" />
							<div>技能</div>
							<div class="dong">如何选泽防嗮服装</div>
							<div><img  src="img/wu.jpg" alt="" /></div>
						</div>	
						</li>
					</ul>
