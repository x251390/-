       ...
       导航
         ...
         <?php include('public/left.php');?>
			...
			<div class="yi center-block">
				<span  class="yi center-block "><a href="" class="active">家庭</a></span>
		...
		<img src="img/家庭.jpg" class="bei img-responsive"/>
	<div class="content2">
		<span>家庭指南</span>
	看一看<br />
让你有意想不到的收获<br />
		...
		<div class="row">
			...
			<div class="col-md-1">
				...
				<div class="col-md-8 clearfix">
					...
					<div class="fu">家庭技能文章<span class="jie">(18条结果)</span></div>
					<div class="clearfix">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="#">Separated link</a></li>
					...
					<ul class="list-inline list-unstyled tu">
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-家庭_03.jpg" alt="" />
							<div>技能</div>
							<div class="dong">和孩子们一起背包</div>
							<div><img  src="img/si.jpg" alt="" /></div>
						</div>	
						</li>
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-家庭_05.gif" alt="" />
							<div>技能</div>
							<div class="dong">野营清单</div>
							<div><img  src="img/si.jpg" alt=""/> </div>
						</div>	
						</li>
					<li>
						<div class="xian1">
							<img class="xing" src="img/专家建议-家庭_07.gif" alt="" />
							<div>技能</div>
							<div class="dong">和小孩一起骑自行车</div>
					...
					<ul class="list-inline list-unstyled tu">
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-家庭_13.gif" alt="" />
							<div>技能</div>
							<div class="dong">和孩子们一起进行寻宝</div>
							<div><img  src="img/si.jpg" alt="" /></div>
						</div>	
						</li>
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-家庭_14.jpg" alt="" />
							<div>技能</div>
							<div class="dong">带上你的狗狗去旅行</div>
							<div><img  src="img/si.jpg" alt=""/> </div>
						</div>	
						</li>
					<li>
						<div class="xian1">
							<img class="xing" src="img/专家建议-家庭_16.gif" alt="" />
							<div>技能</div>
							<div class="dong">带孩子徒步旅行</div>
							<div><img  src="img/wu.jpg" alt="" /></div>
						</div>	
						</li>
					</ul>
					...
					<ul class="list-inline list-unstyled tu">
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-家庭_21.gif" alt="" />
							<div>技能</div>
							<div class="dong">如何骑车</div>
							<div><img  src="img/si.jpg" alt="" /></div>
						</div>	
						</li>
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-家庭_23.gif" alt="" />
							<div>技能</div>
							<div class="dong">如何与宝宝一起露营</div>
							<div><img  src="img/si.jpg" alt=""/> </div>
						</div>	
						</li>
					<li>
						<div class="xian1">
							<img class="xing" src="img/专家建议-家庭_26.gif" alt="" />
							<div>技能</div>
							<div class="dong">如何选泽慢跑婴儿车</div>
							<div><img  src="img/wu.jpg" alt="" /></div>
						</div>	
						</li>
					</ul>
					...
					<ul class="list-inline list-unstyled tu">
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-家庭_30.gif" alt="" />
							<div>技能</div>
							<div class="dong">与孩子们进行寻宝</div>
							<div><img  src="img/si.jpg" alt="" /></div>
						</div>	
						</li>
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-家庭_31.gif" alt="" />
							<div>技能</div>
							<div class="dong">让孩子看星讲星座星</div>
							<div><img  src="img/si.jpg" alt=""/> </div>
						</div>	
						</li>
					<li>
						<div class="xian1">
							<img class="xing" src="img/专家建议-家庭_32.gif" alt="" />
							<div>技能</div>
							<div class="dong">带孩子堆创意雪人</div>
							<div><img  src="img/wu.jpg" alt="" /></div>
						</div>	
						</li>
					</ul>
					...
					<ul class="list-inline list-unstyled tu">
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-家庭_36.gif" alt="" />
							<div>技能</div>
							<div class="dong">如何选择自行车拖车</div>
							<div><img  src="img/si.jpg" alt="" /></div>
						</div>	
						</li>
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-家庭_38.gif" alt="" />
							<div>技能</div>
							<div class="dong">如何选择儿童自行车</div>
							<div><img  src="img/si.jpg" alt=""/> </div>
						</div>	
						</li>
					<li>
						<div class="xian1">
							<img class="xing" src="img/专家建议-家庭_39.gif" alt="" />
							<div>技能</div>
							<div class="dong">如何开始寻宝</div>
							<div><img  src="img/wu.jpg" alt="" /></div>
						</div>	
						</li>
					</ul>
				    ...
				    <ul class="list-inline list-unstyled tu">
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-家庭_44.gif" alt="" />
							<div>技能</div>
							<div class="dong">如何建立一个舒适的露营地</div>
							<div><img  src="img/si.jpg" alt="" /></div>
						</div>	
						</li>
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-家庭_45.gif" alt="" />
							<div>技能</div>
							<div class="dong">如何带孩子们滑雪</div>
							<div><img  src="img/si.jpg" alt=""/> </div>
						</div>	
						</li>
					<li>
						<div class="xian1">
							<img class="xing" src="img/专家建议-家庭_47.gif" alt="" />
							<div>技能</div>
							<div class="dong">与孩子们露营小贴士</div>
							<div><img  src="img/wu.jpg" alt="" /></div>
						</div>	
						</li>
					</ul>
