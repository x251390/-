       ...
       导航
          ...
          <?php include('public/left.php');?>
			...
			<div class="yi center-block">
				...
				<span  class="yi center-block"><a href="#" class="active">露营</a></span>
		...
		<img src="img/专家建议-露营_03.jpg" class="bei img-responsive"/>
	<div class="content2">
		<span>露营指南</span>
	看一看<br />
让你有意想不到的收获<br />
		...
		<div class="row">
			...
			<div class="col-md-1">
				...
				<div class="col-md-8 clearfix">
					...
					<div class="fu">露营技能文章<span class="jie">(18条结果)</span></div>
					<div class="clearfix">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="#">Separated link</a></li>
					...
					<ul class="list-inline list-unstyled tu">
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-露营_07.jpg" alt="" />
							<div>技能</div>
						...
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-露营_09.jpg" alt="" />
							<div>技能</div>
					...
					<li>
						<div class="xian1">
							<img class="xing" src="img/专家建议-露营_11.jpg" alt="" />
							<div>技能</div>
							<div class="dong">露营初学者</div>
					...
					<ul class="list-inline list-unstyled tu">
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-露营_16.jpg" alt="" />
							<div>技能</div>
							<div class="dong">节目露营清单</div>
							<div><img  src="img/si.jpg" alt="" /></div>
						</div>	
						</li>
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-露营_17.jpg" alt="" />
							<div>技能</div>
							<div class="dong">露营者与背包客的食物储存和管理</div>
							<div><img  src="img/si.jpg" alt=""/> </div>
						</div>	
						</li>
					<li>
						<div class="xian1">
							<img class="xing" src="img/专家建议-露营_18.jpg" alt="" />
							<div>技能</div>
					...
					<ul class="list-inline list-unstyled tu">
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-露营_22.jpg" alt="" />
							<div>技能</div>
						...
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-露营_23.jpg" alt="" />
							<div>技能</div>
							<div class="dong">如何护理皮革登上鞋</div>
							<div><img  src="img/si.jpg" alt=""/> </div>
						</div>	
						</li>
					<li>
						<div class="xian1">
							<img class="xing" src="img/专家建议-露营_24.jpg" alt="" />
							<div>技能</div>
					...
					<ul class="list-inline list-unstyled tu">
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-露营_28.jpg" alt="" />
							<div>技能</div>
							<div class="dong">如何选择露营椅</div>
							<div><img  src="img/si.jpg" alt="" /></div>
						</div>	
						</li>
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-露营_29.jpg" alt="" />
							<div>技能</div>
					...
					<li>
						<div class="xian1">
							<img class="xing" src="img/专家建议-露营_30.jpg" alt="" />
							<div>技能</div>
					...
					<ul class="list-inline list-unstyled tu">
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-露营_35.jpg" alt="" />
							<div>技能</div>
						...
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-露营_37.jpg" alt="" />
							<div>技能</div>
					...
					<li>
						<div class="xian1">
							<img class="xing" src="img/专家建议-露营_39.jpg" alt="" />
							<div>技能</div>
							<div class="dong">如何选择可持续服务和装备</div>
							<div><img  src="img/wu.jpg" alt="" /></div>
						</div>	
						</li>
					</ul>
				    ...
				    <ul class="list-inline list-unstyled tu">
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-露营_44.jpg" alt="" />
							<div>技能</div>
						...
						<li>
							<div class="xian1">
							<img class="xing" src="img/专家建议-露营_45.jpg" alt="" />
							<div>技能</div>
							<div class="dong">如何选择野营睡袋</div>
							<div><img  src="img/si.jpg" alt=""/> </div>
						</div>	
						</li>
					<li>
						<div class="xian1">
							<img class="xing" src="img/专家建议-露营_46.jpg" alt="" />
							<div>技能</div>
